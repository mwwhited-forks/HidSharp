...
namespace HidSharp.Platform.Unsupported
{
    sealed class UnsupportedHidManager : HidManager
    {
        ...
        protected override object[] GetHidDeviceKeys() => new object[0];
        protected override object[] GetUsbTmcDeviceKeys() => new object[0];
        protected override object[] GetSerialDeviceKeys() => new object[0];

        protected override bool TryCreateBleDevice(object key, out Device device) => throw new NotImplementedException();
        protected override bool TryCreateHidDevice(object key, out Device device) => throw new NotImplementedException();
        protected override bool TryCreateSerialDevice(object key, out Device device) => throw new NotImplementedException();
