...
{
    /// <summary>
    /// Communicates with a USB TMC class device.
    /// </summary>
    [ComVisible(true), Guid("A80F22A8-745F-4E92-8521-E8477ADF096A")]
    public abstract class UsbTmcStream : DeviceStream
    {
        /// <exclude/>
        protected UsbTmcStream(UsbTmcDevice device)
            : base(device)
        {
            ReadTimeout = 3000;
            WriteTimeout = 3000;
        ...
        /// <summary>
        /// Writes an TMC Output Report to the device.
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="UsbTmcDevice"/> associated with this stream.
        /// </summary>
        public new UsbTmcDevice Device
        {
            get { return (UsbTmcDevice)base.Device; }
        }
    }
}
